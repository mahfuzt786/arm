	...
	$('#loginTxtPass').on('keypress',function(e) {
	    if(e.keyCode == 13) {
			if($('#loginTxtEmail').val())
			{
				...
				$('#popupAlert p#alertMessagez').html('Please enter your Username');
			...
			$.ajax({
				...
				success: function(result) {
					if(result=='done') {
                        ...
                        var msgzz = 'Your password was sent to '+$('input#reclaimAccount').val()+' and SMS message to '+phoneNumber+'<BR> Please check spam folder if you do not see this email from Kamwo in your inbox. <br/><br/><strong>If you do not receive any email, please email us at contact@kamwo.com</strong>';
