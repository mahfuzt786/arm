...
setcookie('blab8_acpkey',$acp_key,time()+3600*$settings['acp_lhours'],'/');
redirect('admin.php');}
...
if(!isset($_COOKIE['blab8_acpkey']) || hsh($settings['acp_key'])!=$_COOKIE['blab8_acpkey']){
$title=$lang['acpkey'];
...
setcookie('blab8_acpkey','',time()+3600,'/');
redirect('admin.php');}
...
case '80u'      : $title=$lang['settings']; $page='80u.pxtm';break;
case '80d'      : $title=$lang['settings']; $page='80d.pxtm';break;
